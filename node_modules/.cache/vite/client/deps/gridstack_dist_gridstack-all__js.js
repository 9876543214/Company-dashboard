  ...
  "node_modules/gridstack/dist/gridstack-all.js"(exports, module) {
    !function(e, t) {
      ...
      class i {
        ...
        static createWidgetDivs(e2, t2) {
          var _a, _b;
          const s2 = i.createDiv(["grid-stack-item", e2]), o2 = i.createDiv(["grid-stack-item-content"], s2);
          return t2.lazyLoad || ((_b = (_a = t2.grid) == null ? void 0 : _a.opts) == null ? void 0 : _b.lazyLoad) && false !== t2.lazyLoad ? t2.visibleObservable || (t2.visibleObservable = new IntersectionObserver(([e3]) => {
            var _a2;
            e3.isIntersecting && ((_a2 = t2.visibleObservable) == null ? void 0 : _a2.disconnect(), delete t2.visibleObservable, x.renderCB(o2, t2));
          }), window.setTimeout(() => {
            var _a2;
            return (_a2 = t2.visibleObservable) == null ? void 0 : _a2.observe(s2);
          })) : x.renderCB(o2, t2), s2;
        }
        ...
        static createStylesheet(e2, t2, i2) {
          const s2 = document.createElement("style"), o2 = i2 == null ? void 0 : i2.nonce;
          return o2 && (s2.nonce = o2), s2.setAttribute("type", "text/css"), s2.setAttribute("gs-style-id", e2), s2.styleSheet ? s2.styleSheet.cssText = "" : s2.appendChild(document.createTextNode("")), t2 ? t2.insertBefore(s2, t2.firstChild) : (t2 = document.getElementsByTagName("head")[0]).appendChild(s2), s2;
        }
        static removeStylesheet(e2, t2) {
          const i2 = (t2 || document).querySelector("STYLE[gs-style-id=" + e2 + "]");
          i2 && i2.parentNode && i2.remove();
        }
        static addCSSRule(e2, t2, i2) {
          e2.textContent += `${t2} { ${i2} } `;
        }
        static toBool(e2) {
        ...
        static simulateMouseEvent(e2, t2, i2) {
          const s2 = document.createEvent("MouseEvents");
          s2.initMouseEvent(t2, true, true, window, 1, e2.screenX, e2.screenY, e2.clientX, e2.clientY, e2.ctrlKey, e2.altKey, e2.shiftKey, e2.metaKey, 0, e2.target), (i2 || e2.target).dispatchEvent(s2);
        }
      ...
      class s {
        ...
        nodeBoundFix(e2, t2) {
          ...
          if (e2.maxW && e2.w && (e2.w = Math.min(e2.w, e2.maxW)), e2.maxH && e2.h && (e2.h = Math.min(e2.h, e2.maxH)), e2.minW && e2.w && e2.minW <= this.column && (e2.w = Math.max(e2.w, e2.minW)), e2.minH && e2.h && (e2.h = Math.max(e2.h, e2.minH)), (e2.x || 0) + (e2.w || 1) > this.column && this.column < this.defaultColumn && !this._inColumnResize && !this.skipCacheUpdate && e2._id && -1 === this.findCacheLayout(e2, this.defaultColumn)) {
            const t3 = { ...e2 };
      ...
      function h(e2, t2) {
        ...
        const i2 = e2.changedTouches[0], s2 = document.createEvent("MouseEvents");
        s2.initMouseEvent(t2, true, true, window, 1, i2.screenX, i2.screenY, i2.clientX, i2.clientY, false, false, false, false, 0, null), e2.target.dispatchEvent(s2);
      }
      function l(e2, t2) {
        e2.cancelable && e2.preventDefault();
        const i2 = document.createEvent("MouseEvents");
        i2.initMouseEvent(t2, true, true, window, 1, e2.screenX, e2.screenY, e2.clientX, e2.clientY, false, false, false, false, 0, null), e2.target.dispatchEvent(i2);
      }
      function d(e2) {
      ...
      class v extends _ {
        ...
        _resizeStop(e2) {
          ...
          return this.option.stop && this.option.stop(t2), this.el.classList.remove("ui-resizable-resizing"), this.triggerEvent("resizestop", t2), this._cleanHelper(), delete this.startEvent, delete this.originalRect, delete this.temporalRect, delete this.scrollY, delete this.scrolled, this;
        }
        _setupHelper() {
          this.elOriginStyleVal = v._originStyleProp.map((e3) => this.el.style[e3]), this.parentOriginStylePosition = this.el.parentElement.style.position;
        ...
        _cleanHelper() {
          return v._originStyleProp.forEach((e2, t2) => {
      ...
      v._originStyleProp = ["width", "height", "position", "left", "top", "opacity", "zIndex"];
      class y extends _ {
        constructor(e2, t2 = {}) {
          var _a;
        ...
        _createHelper() {
          let e2 = this.el;
          return "function" == typeof this.option.helper ? e2 = this.option.helper(this.el) : "clone" === this.option.helper && (e2 = i.cloneNode(this.el)), document.body.contains(e2) || i.appendTo(e2, "parent" === this.option.appendTo ? this.el.parentElement : this.option.appendTo), this.dragElementOriginStyle = y.originStyleProp.map((e3) => this.el.style[e3]), e2;
        }
      ...
      class E {
        static init(e2) {
          return e2.ddElement || (e2.ddElement = new E(e2)), e2.ddElement;
        }
        constructor(e2) {
          this.el = e2;
        }
        ...
        setupResizable(e2) {
          return this.ddResizable ? this.ddResizable.updateOption(e2) : this.ddResizable = new v(this.el, e2), this;
        }
        cleanResizable() {
      ...
      const w = new class {
        resizable(e2, t2, i2, s2) {
          return this._getDDElements(e2).forEach((e3) => {
        ...
        droppable(e2, t2, i2, s2) {
          return "function" != typeof t2.accept || t2._accept || (t2._accept = t2.accept, t2.accept = (e3) => t2._accept(e3)), this._getDDElements(e2).forEach((e3) => {
        ...
        _getDDElements(e2, t2 = true) {
          const s2 = i.getElements(e2);
          if (!s2.length) return [];
          const o2 = s2.map((e3) => e3.ddElement || (t2 ? E.init(e3) : null));
          return t2 || o2.filter((e3) => e3), o2;
        }
      }();
      class x {
        ...
        constructor(e2, t2 = {}) {
          ...
          let h2 = (_a = t2.columnOpts) == null ? void 0 : _a.breakpoints;
          const l2 = t2;
          if (l2.oneColumnModeDomSort && (delete l2.oneColumnModeDomSort, console.log("warning: Gridstack oneColumnModeDomSort no longer supported. Use GridStackOptions.columnOpts instead.")), l2.oneColumnSize || false === l2.disableOneColumnMode) {
            const e3 = l2.oneColumnSize || 768;
            delete l2.oneColumnSize, delete l2.disableOneColumnMode, t2.columnOpts = t2.columnOpts || {}, h2 = t2.columnOpts.breakpoints = t2.columnOpts.breakpoints || [];
            let i2 = h2.find((e4) => 1 === e4.c);
            i2 ? i2.w = e3 : (i2 = { c: 1, w: e3 }, h2.push(i2, { c: 12, w: e3 + 1 }));
          }
          const d2 = t2.columnOpts;
          d2 && (d2.columnWidth || ((_b = d2.breakpoints) == null ? void 0 : _b.length) ? d2.columnMax = d2.columnMax || 12 : (delete t2.columnOpts, h2 = void 0)), (h2 == null ? void 0 : h2.length) > 1 && h2.sort((e3, t3) => (t3.w || 0) - (e3.w || 0));
          const c2 = { ...i.cloneDeep(o), column: i.toNumber(e2.getAttribute("gs-column")) || o.column, minRow: a2 || i.toNumber(e2.getAttribute("gs-min-row")) || o.minRow, maxRow: a2 || i.toNumber(e2.getAttribute("gs-max-row")) || o.maxRow, staticGrid: i.toBool(e2.getAttribute("gs-static")) || o.staticGrid, sizeToContent: i.toBool(e2.getAttribute("gs-size-to-content")) || void 0, draggable: { handle: (t2.handleClass ? "." + t2.handleClass : t2.handle ? t2.handle : "") || o.draggable.handle }, removableOptions: { accept: t2.itemClass || o.removableOptions.accept, decline: o.removableOptions.decline } };
          e2.getAttribute("gs-animate") && (c2.animate = i.toBool(e2.getAttribute("gs-animate"))), t2 = i.defaults(t2, c2), this._initMargin(), this.checkDynamicColumn(), this.el.classList.add("gs-" + t2.column), "auto" === t2.rtl && (t2.rtl = "rtl" === e2.style.direction), t2.rtl && this.el.classList.add("grid-stack-rtl");
          const g2 = this.el.closest("." + o.itemClass), u2 = g2 == null ? void 0 : g2.gridstackNode;
          u2 && (u2.subGrid = this, this.parentGridNode = u2, this.el.classList.add("grid-stack-nested"), u2.el.classList.add("grid-stack-sub-grid")), this._isAutoCellHeight = "auto" === t2.cellHeight, this._isAutoCellHeight || "initial" === t2.cellHeight ? this.cellHeight(void 0, false) : ("number" == typeof t2.cellHeight && t2.cellHeightUnit && t2.cellHeightUnit !== o.cellHeightUnit && (t2.cellHeight = t2.cellHeight + t2.cellHeightUnit, delete t2.cellHeightUnit), this.cellHeight(t2.cellHeight, false)), "mobile" === t2.alwaysShowResizeHandle && (t2.alwaysShowResizeHandle = r), this._styleSheetClass = "gs-id-" + s._idSeq++, this.el.classList.add(this._styleSheetClass), this._setStaticClass();
          const p2 = t2.engineClass || x.engineClass || s;
          if (this.engine = new p2({ column: this.getColumn(), float: t2.float, maxRow: t2.maxRow, onChange: (e3) => {
            let t3 = 0;
            this.engine.nodes.forEach((e4) => {
              t3 = Math.max(t3, e4.y + e4.h);
            }), e3.forEach((e4) => {
              const t4 = e4.el;
              t4 && (e4._removeDOM ? (t4 && t4.remove(), delete e4._removeDOM) : this._writePosAttr(t4, e4));
            }), this._updateStyles(false, t3);
          } }), this._updateStyles(false, 0), t2.auto && (this.batchUpdate(), this.engine._loading = true, this.getGridItems().forEach((e3) => this._prepareElement(e3)), delete this.engine._loading, this.batchUpdate(false)), t2.children) {
            const e3 = t2.children;
            delete t2.children, e3.length && this.load(e3);
          }
          this.setAnimation(), t2.subGridDynamic && !n.pauseDrag && (n.pauseDrag = true), void 0 !== ((_c = t2.draggable) == null ? void 0 : _c.pause) && (n.pauseDrag = t2.draggable.pause), this._setupRemoveDrop(), this._setupAcceptWidget(), this._updateResizeEvent();
        }
        addWidget(e2) {
          ...
          let t2, s2 = e2;
          if (s2.grid = this, t2 = (s2 == null ? void 0 : s2.el) ? s2.el : x.addRemoveCB ? x.addRemoveCB(this.el, e2, true, false) : i.createWidgetDivs(this.opts.itemClass, s2), !t2) return;
        ...
        load(e2, t2 = x.addRemoveCB || true) {
          ...
          }), o2 > this.engine.defaultColumn && (this.engine.defaultColumn = o2), o2 > s2 && this.engine.cacheLayout(e2, o2, true);
          const n2 = x.addRemoveCB;
          "function" == typeof t2 && (x.addRemoveCB = t2);
          const r2 = [];
          this.batchUpdate();
          const a2 = !this.engine.nodes.length;
          a2 && this.setAnimation(false), !a2 && t2 && [...this.engine.nodes].forEach((t3) => {
          ...
          }), delete this.engine._loading, this.engine.removedNodes = r2, this.batchUpdate(false), delete this._ignoreLayoutsNodeChange, delete this.engine.skipCacheUpdate, n2 ? x.addRemoveCB = n2 : delete x.addRemoveCB, a2 && ((_a = this.opts) == null ? void 0 : _a.animate) && this.setAnimation(this.opts.animate, true), this;
        }
        batchUpdate(e2 = true) {
        ...
        cellHeight(e2, t2 = true) {
          if (t2 && void 0 !== e2 && this._isAutoCellHeight !== ("auto" === e2) && (this._isAutoCellHeight = "auto" === e2, this._updateResizeEvent()), "initial" !== e2 && "auto" !== e2 || (e2 = void 0), void 0 === e2) {
            const t3 = -this.opts.marginRight - this.opts.marginLeft + this.opts.marginTop + this.opts.marginBottom;
            e2 = this.cellWidth() + t3;
          }
          const s2 = i.parseHeight(e2);
          return this.opts.cellHeightUnit === s2.unit && this.opts.cellHeight === s2.h || (this.opts.cellHeightUnit = s2.unit, this.opts.cellHeight = s2.h, this.resizeToContentCheck(), t2 && this._updateStyles(true)), this;
        }
        cellWidth() {
        ...
        destroy(e2 = true) {
          var _a, _b;
          if (this.el) return this.offAll(), this._updateResizeEvent(true), this.setStatic(true, false), this.setAnimation(false), e2 ? this.el.parentNode.removeChild(this.el) : (this.removeAll(e2), this.el.classList.remove(this._styleSheetClass), this.el.removeAttribute("gs-current-row")), this._removeStylesheet(), (_a = this.parentGridNode) == null ? true : delete _a.subGrid, delete this.parentGridNode, delete this.opts, (_b = this._placeholder) == null ? true : delete _b.gridstackNode, delete this._placeholder, delete this.engine, delete this.el.gridstack, delete this.el, this;
        }
        float(e2) {
        ...
        setAnimation(e2 = this.opts.animate, t2) {
          ...
          }) : e2 ? this.el.classList.add("grid-stack-animate") : this.el.classList.remove("grid-stack-animate"), this;
        }
        hasAnimationCSS() {
        ...
        setStatic(e2, t2 = true, i2 = true) {
          return !!this.opts.staticGrid === e2 || (e2 ? this.opts.staticGrid = true : delete this.opts.staticGrid, this._setupRemoveDrop(), this._setupAcceptWidget(), this.engine.nodes.forEach((s2) => {
            this._prepareDragDropByNode(s2), s2.subGrid && i2 && s2.subGrid.setStatic(e2, t2, i2);
        ...
        update(e2, t2) {
          if (arguments.length > 2) {
            ...
            const i2 = arguments;
            let s2 = 1;
            return t2 = { x: i2[s2++], y: i2[s2++], w: i2[s2++], h: i2[s2++] }, this.update(e2, t2);
          }
          return x.getElements(e2).forEach((e3) => {
            var _a;
            const s2 = e3 == null ? void 0 : e3.gridstackNode;
            if (!s2) return;
            const o2 = i.cloneDeep(t2);
            ...
            if (n2.some((e4) => void 0 !== o2[e4] && o2[e4] !== s2[e4]) && (r2 = {}, n2.forEach((e4) => {
              ...
              t3 && t3.textContent !== o2.content && (s2.content = o2.content, x.renderCB(t3, o2), ((_a = s2.subGrid) == null ? void 0 : _a.el) && (t3.appendChild(s2.subGrid.el), s2.subGrid.opts.styleInHead || s2.subGrid._updateStyles(true))), delete o2.content;
            }
            ...
            (r2 || a2) && this._writeAttr(e3, s2), h2 && this._prepareDragDropByNode(s2);
          }), this;
        }
        moveNode(e2, t2) {
        ...
        resizeToContent(e2) {
          ...
          if (t2.subGrid) {
            ...
            const e3 = t2.subGrid.el.getBoundingClientRect(), i3 = t2.subGrid.el.parentElement.getBoundingClientRect();
            h2 += e3.top - i3.top;
          } else {
        ...
        margin(e2) {
          ...
          return this.opts.margin = e2, this.opts.marginTop = this.opts.marginBottom = this.opts.marginLeft = this.opts.marginRight = void 0, this._initMargin(), this._updateStyles(true), this;
        }
        getMargin() {
        ...
        _triggerEvent(e2, t2) {
          ...
          return this.el.dispatchEvent(i2), this;
        }
        _removeStylesheet() {
          if (this._styles) {
            const e2 = this.opts.styleInHead ? void 0 : this.el.parentNode;
            i.removeStylesheet(this._styleSheetClass, e2), delete this._styles;
          }
          return this;
        }
        _updateStyles(e2 = false, t2) {
          if (e2 && this._removeStylesheet(), void 0 === t2 && (t2 = this.getRow()), this._updateContainerHeight(), 0 === this.opts.cellHeight) return this;
          const s2 = this.opts.cellHeight, o2 = this.opts.cellHeightUnit, n2 = `.${this._styleSheetClass} > .${this.opts.itemClass}`;
          if (!this._styles) {
            const e3 = this.opts.styleInHead ? void 0 : this.el.parentNode;
            if (this._styles = i.createStylesheet(this._styleSheetClass, e3, { nonce: this.opts.nonce }), !this._styles) return this;
            this._styles._max = 0, i.addCSSRule(this._styles, n2, `height: ${s2}${o2}`);
            const t3 = this.opts.marginTop + this.opts.marginUnit, r2 = this.opts.marginBottom + this.opts.marginUnit, a2 = this.opts.marginRight + this.opts.marginUnit, h2 = this.opts.marginLeft + this.opts.marginUnit, l2 = `${n2} > .grid-stack-item-content`, d2 = `.${this._styleSheetClass} > .grid-stack-placeholder > .placeholder-content`;
            i.addCSSRule(this._styles, l2, `top: ${t3}; right: ${a2}; bottom: ${r2}; left: ${h2};`), i.addCSSRule(this._styles, d2, `top: ${t3}; right: ${a2}; bottom: ${r2}; left: ${h2};`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-n`, `top: ${t3};`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-s`, `bottom: ${r2}`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-ne`, `right: ${a2}; top: ${t3}`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-e`, `right: ${a2}`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-se`, `right: ${a2}; bottom: ${r2}`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-nw`, `left: ${h2}; top: ${t3}`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-w`, `left: ${h2}`), i.addCSSRule(this._styles, `${n2} > .ui-resizable-sw`, `left: ${h2}; bottom: ${r2}`);
          }
          if ((t2 = t2 || this._styles._max) > this._styles._max) {
            const e3 = (e4) => s2 * e4 + o2;
            for (let s3 = this._styles._max + 1; s3 <= t2; s3++) i.addCSSRule(this._styles, `${n2}[gs-y="${s3}"]`, `top: ${e3(s3)}`), i.addCSSRule(this._styles, `${n2}[gs-h="${s3 + 1}"]`, `height: ${e3(s3 + 1)}`);
            this._styles._max = t2;
          }
          return this;
        }
        _updateContainerHeight() {
          ...
          return this.el.setAttribute("gs-current-row", String(t2)), this.el.style.removeProperty("min-height"), this.el.style.removeProperty("height"), t2 && (this.el.style[e2 ? "minHeight" : "height"] = t2 * s2 + o2), e2 && !e2.grid.engine.batchMode && i.shouldSizeToContent(e2) && e2.grid.resizeToContentCBCheck(e2.el), this;
        }
        _prepareElement(e2, t2 = false, s2) {
          ...
          return n2 ? e2.classList.add("size-to-content") : e2.classList.remove("size-to-content"), n2 && this.resizeToContentCheck(false, s2), this._prepareDragDropByNode(s2), this;
        }
        _writePosAttr(e2, t2) {
          return void 0 !== t2.x && null !== t2.x && e2.setAttribute("gs-x", String(t2.x)), void 0 !== t2.y && null !== t2.y && e2.setAttribute("gs-y", String(t2.y)), t2.w > 1 ? e2.setAttribute("gs-w", String(t2.w)) : e2.removeAttribute("gs-w"), t2.h > 1 ? e2.setAttribute("gs-h", String(t2.h)) : e2.removeAttribute("gs-h"), this;
        }
        _writeAttr(e2, t2) {
          if (!t2) return this;
        ...
        _initMargin() {
          let e2, t2 = 0, s2 = [];
          return "string" == typeof this.opts.margin && (s2 = this.opts.margin.split(" ")), 2 === s2.length ? (this.opts.marginTop = this.opts.marginBottom = s2[0], this.opts.marginLeft = this.opts.marginRight = s2[1]) : 4 === s2.length ? (this.opts.marginTop = s2[0], this.opts.marginRight = s2[1], this.opts.marginBottom = s2[2], this.opts.marginLeft = s2[3]) : (e2 = i.parseHeight(this.opts.margin), this.opts.marginUnit = e2.unit, t2 = this.opts.margin = e2.h), void 0 === this.opts.marginTop ? this.opts.marginTop = t2 : (e2 = i.parseHeight(this.opts.marginTop), this.opts.marginTop = e2.h, delete this.opts.margin), void 0 === this.opts.marginBottom ? this.opts.marginBottom = t2 : (e2 = i.parseHeight(this.opts.marginBottom), this.opts.marginBottom = e2.h, delete this.opts.margin), void 0 === this.opts.marginRight ? this.opts.marginRight = t2 : (e2 = i.parseHeight(this.opts.marginRight), this.opts.marginRight = e2.h, delete this.opts.margin), void 0 === this.opts.marginLeft ? this.opts.marginLeft = t2 : (e2 = i.parseHeight(this.opts.marginLeft), this.opts.marginLeft = e2.h, delete this.opts.margin), this.opts.marginUnit = e2.unit, this.opts.marginTop === this.opts.marginBottom && this.opts.marginLeft === this.opts.marginRight && this.opts.marginTop === this.opts.marginRight && (this.opts.margin = this.opts.marginTop), this;
        }
        static getDD() {
          return w;
        }
        static setupDragIn(e2, t2, s2, o2 = document) {
          void 0 !== (t2 == null ? void 0 : t2.pause) && (n.pauseDrag = t2.pause), t2 = { appendTo: "body", helper: "clone", ...t2 || {} }, ("string" == typeof e2 ? i.getElements(e2, o2) : e2).forEach((e3, i2) => {
            w.isDraggable(e3) || w.dragIn(e3, t2), (s2 == null ? void 0 : s2[i2]) && (e3.gridstackNode = s2[i2]);
          });
        }
        movable(e2, t2) {
          return this.opts.staticGrid || x.getElements(e2).forEach((e3) => {
            const i2 = e3.gridstackNode;
            i2 && (t2 ? delete i2.noMove : i2.noMove = true, this._prepareDragDropByNode(i2));
          }), this;
        }
        resizable(e2, t2) {
          return this.opts.staticGrid || x.getElements(e2).forEach((e3) => {
            const i2 = e3.gridstackNode;
            i2 && (t2 ? delete i2.noResize : i2.noResize = true, this._prepareDragDropByNode(i2));
          }), this;
        }
        disable(e2 = true) {
        ...
        enableMove(e2, t2 = true) {
          return this.opts.staticGrid || (e2 ? delete this.opts.disableDrag : this.opts.disableDrag = true, this.engine.nodes.forEach((i2) => {
            this._prepareDragDropByNode(i2), i2.subGrid && t2 && i2.subGrid.enableMove(e2, t2);
          })), this;
        }
        enableResize(e2, t2 = true) {
          return this.opts.staticGrid || (e2 ? delete this.opts.disableResize : this.opts.disableResize = true, this.engine.nodes.forEach((i2) => {
            this._prepareDragDropByNode(i2), i2.subGrid && t2 && i2.subGrid.enableResize(e2, t2);
          })), this;
        }
        cancelDrag() {
          var _a;
        ...
        _removeDD(e2) {
          return w.draggable(e2, "destroy").resizable(e2, "destroy"), e2.gridstackNode && delete e2.gridstackNode._initDD, delete e2.ddElement, this;
        }
        _setupAcceptWidget() {
          if (this.opts.staticGrid || !this.opts.acceptWidgets && !this.opts.removable) return w.droppable(this.el, "destroy"), this;
          let e2, t2;
          const s2 = (s3, o2, n2) => {
            var _a;
            ...
            if (r2._temporaryRemoved) {
              if (r2.x = Math.max(0, Math.round(h2 / t2)), r2.y = Math.max(0, Math.round(a2 / e2)), delete r2.autoPosition, this.engine.nodeBoundFix(r2), !this.engine.willItFit(r2)) {
                if (r2.autoPosition = true, !this.engine.willItFit(r2)) return void w.off(o2, "drag");
          ...
          return w.droppable(this.el, { accept: (e3) => {
            ...
            if ((r2 == null ? void 0 : r2.grid) && r2.grid !== this && !r2._temporaryRemoved && r2.grid._leave(o2, n2), n2 = n2 || o2, t2 = this.cellWidth(), e2 = this.getCellHeight(true), !r2) {
            ...
            const a2 = n2 && this.opts.animate;
            a2 && this.setAnimation(false);
            const h2 = t3._gridstackNodeOrig;
            if (delete t3._gridstackNodeOrig, n2 && (h2 == null ? void 0 : h2.grid) && h2.grid !== this) {
              const e4 = h2.grid;
              e4.engine.removeNodeFromLayoutCache(h2), e4.engine.removedNodes.push(h2), e4._triggerRemoveEvent()._triggerChangeEvent(), e4.parentGridNode && !e4.engine.nodes.length && e4.opts.subGridDynamic && e4.removeAsSubGrid();
            }
            if (!o2) return false;
            if (n2 && (this.engine.cleanupNode(o2), o2.grid = this), (_a = o2.grid) == null ? true : delete _a._isTemp, w.off(t3, "drag"), s3 !== t3 ? (s3.remove(), t3 = s3) : t3.remove(), this._removeDD(t3), !n2) return false;
            const l2 = (_c = (_b = o2.subGrid) == null ? void 0 : _b.el) == null ? void 0 : _c.gridstack;
            return i.copyPos(o2, this._readAttr(this.placeholder)), i.removePositioningStyles(t3), r2 && (o2.content || o2.subGridOpts || x.addRemoveCB) ? (delete o2.el, t3 = this.addWidget(o2)) : (this._prepareElement(t3, true, o2), this.el.appendChild(t3), this.resizeToContentCheck(false, o2), l2 && (l2.parentGridNode = o2, l2.opts.styleInHead || l2._updateStyles(true)), this._updateContainerHeight()), this.engine.addedNodes.push(o2), this._triggerAddEvent(), this._triggerChangeEvent(), this.engine.endUpdate(), this._gsEventHandler.dropped && this._gsEventHandler.dropped({ ...e3, type: "dropped" }, h2 && h2.grid ? h2 : void 0, o2), a2 && this.setAnimation(this.opts.animate, true), false;
          }), this;
        }
        ...
        _setupRemoveDrop() {
          ...
          return e2 ? (this.opts.staticGrid || w.isDroppable(e2) || w.droppable(e2, this.opts.removableOptions).on(e2, "dropover", (e3, t2) => x._itemRemoving(t2, true)).on(e2, "dropout", (e3, t2) => x._itemRemoving(t2, false)), this) : this;
        }
        _prepareDragDropByNode(e2) {
          const t2 = e2.el, s2 = e2.noMove || this.opts.disableDrag, o2 = e2.noResize || this.opts.disableResize;
          if (this.opts.staticGrid || s2 && o2) return e2._initDD && (this._removeDD(t2), delete e2._initDD), t2.classList.add("ui-draggable-disabled", "ui-resizable-disabled"), this;
          if (!e2._initDD) {
            let s3, o3;
            const n2 = (i2, n3) => {
              this._gsEventHandler[i2.type] && this._gsEventHandler[i2.type](i2, i2.target), s3 = this.cellWidth(), o3 = this.getCellHeight(true), this._onStartMoving(t2, i2, n3, e2, s3, o3);
            }, r2 = (i2, n3) => {
              this._dragOrResize(t2, i2, n3, e2, s3, o3);
            }, a2 = (s4) => {
              this.placeholder.remove(), delete this.placeholder.gridstackNode, delete e2._moving, delete e2._event, delete e2._lastTried;
              const o4 = e2.w !== e2._orig.w, n3 = s4.target;
              if (n3.gridstackNode && n3.gridstackNode.grid === this) {
                if (e2.el = n3, e2._isAboutToRemove) {
                  const i2 = t2.gridstackNode.grid;
                  i2._gsEventHandler[s4.type] && i2._gsEventHandler[s4.type](s4, n3), i2.engine.nodes.push(e2), i2.removeWidget(t2, true, true);
                } else i.removePositioningStyles(n3), e2._temporaryRemoved ? (i.copyPos(e2, e2._orig), this._writePosAttr(n3, e2), this.engine.addNode(e2)) : this._writePosAttr(n3, e2), this._gsEventHandler[s4.type] && this._gsEventHandler[s4.type](s4, n3);
                this._extraDragRow = 0, this._updateContainerHeight(), this._triggerChangeEvent(), this.engine.endUpdate(), "resizestop" === s4.type && (Number.isInteger(e2.sizeToContent) && (e2.sizeToContent = e2.h), this.resizeToContentCheck(o4, e2));
              }
            };
            w.draggable(t2, { start: n2, stop: a2, drag: r2 }).resizable(t2, { start: n2, stop: a2, resize: r2 }), e2._initDD = true;
          }
          return w.draggable(t2, s2 ? "disable" : "enable").resizable(t2, o2 ? "disable" : "enable"), this;
        }
        ...
        _dragOrResize(e2, t2, s2, o2, n2, r2) {
          ...
          if (this.engine.moveNodeCheck(o2, { ...a2, cellWidth: n2, cellHeight: r2, rect: m2, resizing: h2 })) {
            ...
            const e3 = t2.target;
            this._writePosAttr(e3, o2), this._gsEventHandler[t2.type] && this._gsEventHandler[t2.type](t2, e3);
          }
        }
        _leave(e2, t2) {
          const i2 = (t2 = t2 || e2).gridstackNode;
          i2 && (t2.style.transform = t2.style.transformOrigin = null, w.off(e2, "drag"), i2._temporaryRemoved || (i2._temporaryRemoved = true, this.engine.removeNode(i2), i2.el = i2._isExternal && t2 ? t2 : e2, i2._isExternal && this.engine.cleanupNode(i2), true === this.opts.removable && x._itemRemoving(e2, true), e2._gridstackNodeOrig ? (e2.gridstackNode = e2._gridstackNodeOrig, delete e2._gridstackNodeOrig) : i2._isExternal && this.engine.restoreInitial()));
        }
        commit() {
      ...
      }, x.resizeToContentParent = ".grid-stack-item-content", x.Utils = i, x.Engine = s, x.GDRev = "11.3.0", t.GridStack;
    })());
  }
});
...
*/
//# sourceMappingURL=gridstack_dist_gridstack-all__js.js.map
