        ...
        function(module2, __webpack_exports__, __webpack_require__) {
          ...
          class InteractableSet_InteractableSet {
            ...
            constructor(scope) {
              ...
              scope.addListeners({
                "interactable:unset": ({
                  ...
                  const targetIndex = findIndex(targetMappings, (m2) => m2.context === context);
            ...
            get(target, options) {
              ...
              const found = find(targetMappings, (m2) => m2.context === context && (isSelector || m2.interactable.inContext(target)));
          ...
          var GridItemvue_type_script_lang_js_ = {
            ...
            watch: {
              ...
              "$parent.margin": function $parentMargin(margin) {
                ...
                this.margin = margin.map(function(m2) {
                  return Number(m2);
                });
                this.createStyle();
                this.emitContainerResized();
