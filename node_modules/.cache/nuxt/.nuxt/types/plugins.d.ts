...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../../../vuetify-nuxt-module/dist/runtime/plugins/vuetify-client-hints.client.js")> &
  ...
  InjectionType<typeof import("../../../../vuetify-nuxt-module/dist/runtime/plugins/vuetify-client-hints.server.js")>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'vuetify:icons:plugin' | 'vuetify:client-hints:client:plugin' | 'nuxt:head' | 'nuxt:router' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'vuetify:client-hints:server:plugin' | 'vuetify:nuxt:server:plugin' | 'vuetify:nuxt:client:plugin'
  }
}
