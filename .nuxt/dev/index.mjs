...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/devalue/index.js';
import destr from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/unenv/runtime/fetch/index.mjs';
import { hash } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/node_modules/@unhead/shared/dist/index.mjs';
...
const _ZWapp5bsDn = (function(nitro) {
...
const _lazy_ebpDmG = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ebpDmG, lazy: true, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_ebpDmG, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ebpDmG, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\Ulrik\\Python\\Vue.js\\Company-desktop\\Company-desktop","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\Ulrik\\Python\\Vue.js\\Company-desktop\\Company-desktop\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\Ulrik\\Python\\Vue.js\\Company-desktop\\Company-desktop\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\Ulrik\\Python\\Vue.js\\Company-desktop\\Company-desktop\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\Ulrik\\Python\\Vue.js\\Company-desktop\\Company-desktop\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/Ulrik/Python/Vue.js/Company-desktop/Company-desktop/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
